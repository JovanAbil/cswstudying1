...
export const AdPlaceholder = ({ position, className = '' }: AdPlaceholderProps) => {
  ...
  const positionStyles = {
    // pointer-events-none so ads don't block content interaction
    'sidebar-left': 'fixed left-2 top-1/2 -translate-y-1/2 w-[160px] h-[600px] pointer-events-none',
    'sidebar-right': 'fixed right-2 top-1/2 -translate-y-1/2 w-[160px] h-[600px] pointer-events-none',
