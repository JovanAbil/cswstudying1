...
export const AdPlaceholder = ({ position, className = '' }: AdPlaceholderProps) => {
  ...
  const positionStyles = {
    ...
    'sidebar-left': 'fixed left-2 top-1/2 -translate-y-1/2 w-[160px] h-[600px] z-10 pointer-events-none',
    'sidebar-right': 'fixed right-2 top-1/2 -translate-y-1/2 w-[160px] h-[600px] z-10 pointer-events-none',
