...
export const compoundsQuestions: Question[] = [
  ...
  },
  {
    id: "compounds-3",
    type: "multiple-choice",
    question: "What type of bond is expected between atoms of phosphorous and silicon",
    options: [
      { label: "A", value: "A", text: "Metallic" },
      { label: "B", value: "B", text: "Polar Covalent" },
      { label: "C", value: "C", text: "Nonpolar Covalent" },
  ...
  },
  {
    id: "compounds-9",
    type: "free-response",
    question: "What is the Geometry and Polarity of SeCl6 and does it have resonance? Draw the structure",
  ...
  },
  {
    id: "compounds-12",
    type: "free-response",
    question: "What is the Geometry and Polarity of TeCl4 and does it have resonance? Draw the structure",
    correctAnswer: "Seesaw, Polar, No Resonance",
    explanation: "TeCl4 has 4 bonds + 1 lone pair → seesaw. Lone pair generates polarity. No resonance."
  },
  {
    id: "compounds-13",
    type: "free-response",
    ...
    explanation: "ClF3 has 3 bonds + 2 lone pairs → T-shaped. Lone pairs create polarity. No resonance."
  },
  {
    id: "compounds-14",
    type: "free-response",
  ...
  },
  {
    ...
    type: "free-response",
    question: "Name Rb3As",
    correctAnswer: "Rubidium Arsenide",
